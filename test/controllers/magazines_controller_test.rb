...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post magazines_url, params: { magazine: { apercu: @magazine.apercu, titre: @magazine.titre } }
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { apercu: @magazine.apercu, titre: @magazine.titre } }
