...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post magazines_url, params: { magazine: { thumbnail: @magazine.thumbnail, titre: @magazine.titre } }
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { thumbnail: @magazine.thumbnail, titre: @magazine.titre } }
