...
class MangasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manga" do
    assert_difference('Manga.count') do
      post mangas_url, params: { manga: { thumbnail: @manga.thumbnail, titre: @manga.titre } }
    end
  ...
  test "should update manga" do
    patch manga_url(@manga), params: { manga: { thumbnail: @manga.thumbnail, titre: @manga.titre } }
