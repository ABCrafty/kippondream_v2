...
class Admin::ArticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_article" do
    assert_difference('Admin::Article.count') do
      post admin_articles_url, params: { admin_article: { contenu: @admin_article.contenu, titre: @admin_article.titre } }
    end
  ...
  test "should update admin_article" do
    patch admin_article_url(@admin_article), params: { admin_article: { contenu: @admin_article.contenu, titre: @admin_article.titre } }
